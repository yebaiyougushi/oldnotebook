...
import com.example.oldnotebook.R;
import com.example.oldnotebook.adapter.DrawerAdapter;
import com.example.oldnotebook.adapter.NoteAdapter;
import com.example.oldnotebook.bean.Note;
import com.example.oldnotebook.db.MetaData;
import com.example.oldnotebook.utils.LogUtils;
...
public class NoteMainActivity extends ListActivity implements
    ...
    private String mSort = MetaData.NoteColumns.SORT_ORDER_DEFAULT;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String APPLICATION_ID = "78b513daedf6fbec9c8f442a7a20c5d0";
...
//                .setFileExpiration(2500)//文件的过期时间(单位为秒)：默认1800s
        ...
        mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout,
                null, R.string.about, R.string.about_author) {
            @Override
        ...
        mSort = sp
                .getString(NoteUtil.LIST_SORT, MetaData.NoteColumns.SORT_ORDER_DEFAULT);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_note_sort_by_default:
                mSort = MetaData.NoteColumns.SORT_ORDER_DEFAULT;
            ...
            case R.id.menu_note_sort_by_date:
                mSort = MetaData.NoteColumns.SORT_ORDER_TIME;
            ...
            case R.id.menu_note_sort_by_type:
                mSort = MetaData.NoteColumns.SORT_ORDER_GROUP;
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        if (mSearchString == null) {
            ...
            if (!GROUP_ALL.equals(mGroup)) {
                selection = MetaData.NoteColumns.GROUP + "=?";
            ...
            switch (item.getItemId()) {
                ...
                case R.id.actionbar_delete:
                    ...
                    for (int pos = getListView().getCount() - 1; pos >= 0; pos--) {
                        if (mAdapter.isSelected(pos)) {
                            ...
                            long id = cursor.getLong(cursor
                                    .getColumnIndex(MetaData.NoteColumns._ID));
                            String objectId = cursor.getString(cursor.getColumnIndex(MetaData.NoteColumns.OBJECT_ID));
                            selectedList.add(id);
                    ...
                    new AlertDialog.Builder(mContext)
                            ...
                            .setMessage(
                                    getString(selectedList.size(), R.string.delete_msg_multi))
                                    ...
                                    new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog,
                                            ...
                                            for (int i = 0; i < objectIdStrings.size(); i++) {
                                                ...
                                                notes.add(note);
                                                bmobObject.delete(note.getObjectId(), new UpdateListener() {
													...
													public void done(BmobException e) {
														if (e == null) {
															...
															LogUtils.e(TAG, "delete failed:" + e.toString());
														}
													}
...
//				});
        ...
        private void setSubtitle(ActionMode mode) {
            ...
            mSelectBtn.setText(getString(checkedCount, R.string.selected_msg));
